...
class Window1:
    def __init__(self,master):
        ...
        self.btnLogin = Button(self.Loginframe2,text='Login',width=17,font=('arial',20,'bold'),  command=self.Registration_window)
        self.btnLogin.grid(row=0,column =0)

        self.btnReset = Button(self.Loginframe2,text='Reset',width=17,font=('arial',20,'bold'), command=self.Hospital_window)
        self.btnReset.grid(row=0,column =1)

        self.btnExit = Button(self.Loginframe2,text='Exit', width=17,font=('arial',20,'bold'), command=self.Registration_window)
        self.btnExit.grid(row=0,column =2)


        self.btnRegistration = Button(self.Loginframe3,text='Patients Registration System',font=('arial',20,'bold'),state=DISABLED,  command=self.Registration_window)
        self.btnRegistration.grid(row=0,column =0)

        self.btnHospital = Button(self.Loginframe3,text='Hospital Management System',font=('arial',20,'bold'),state=DISABLED, command=self.Hospital_window)
